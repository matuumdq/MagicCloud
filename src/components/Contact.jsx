...
const Contact = () => {
	...
	return (
		<section
			data-aos="fade-up"
			id="contact"
			className="bg-white min-h-screen flex justify-center items-center overflow-hidden relative z-10"
		>
			<img
				src="https://images.pexels.com/photos/3183150/pexels-photo-3183150.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
				alt=""
				className="absolute object-cover w-full h-full z-10 hidden md:block opacity-40"
			/>
			<div
				data-aos="fade-down"
				className="container max-w-screen-xl mx-auto relative z-20 py-20 lg:py-[120px]"
			>
